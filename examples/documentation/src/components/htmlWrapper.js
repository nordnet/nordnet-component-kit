function htmlWrapper(props) {
  ...
  const index = props.assets.index ? props.assets.index.replace('/', '') : 'index.js';
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://fonts.googleapis.com/css?family=Open+Sans:400,400italic,600,600italic,700,700italic"
      type="text/css">
