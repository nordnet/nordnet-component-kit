...
const IconRow = ({ Tag, icon, topLeft, bottomLeft, topRight, bottomRight, minHeight, style, infoStyles, rowStyles, iconStyles }) => {
  ...
  return (
    <Tag style={divStyles}>
      <div style={iconPlacementStyles}>{icon}</div>
      <span style={infoStyle}>
        <span style={listRowStyles}>
          <RowInfo leftItem={topLeft} rightItem={topRight} />
          <RowInfo alignBaseline leftItem={bottomLeft} rightItem={bottomRight} />
        </span>
      </span>
    </Tag>
  );
